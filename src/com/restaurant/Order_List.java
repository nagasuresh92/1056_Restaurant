...
public class Order_List extends Activity {
	 ...
	 public void onCreate(Bundle savedInstanceState) {
	       ...
	       //initialise list view to dispay data in list
	        ...
	        orderModelClass = new ModelClass(cust_name, phone, email, address);
	      ...
	      adapter=new ArrayAdapter<String>(Order_List.this,
	        ...
	        list.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0,
					...
					AlertDialog.Builder builder =new AlertDialog.Builder(Order_List.this);
	        ...
	        gotomenu.setOnClickListener(new OnClickListener() {
	        	...
	        	public void onClick(View v) {
	        		Intent menuIntent = new Intent(Order_List.this,MenuScreen.class);
	      ...
	      placedorder.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				try{
					...
					if(r == 1){
					Toast.makeText(Order_List.this, "Your order has been received", Toast.LENGTH_LONG).show();
					//pd.dismiss();
					}
				}
				catch(Exception e){
